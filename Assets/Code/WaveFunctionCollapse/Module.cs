...
public class Module {
	...
	// Per-district probability multipliers — indexed by (int)ArchStyle, precomputed at init
	[System.NonSerialized]
	public float[] DistrictWeights;
	...
	public static void Initialize4DNeighbors(Module[] modules) {
		foreach (var module in modules) {
			...
			module.DistrictWeights = DistrictBiasProvider.ComputeWeights(module.Name, module.Prototype.StyleAffinity);
		}
	}
