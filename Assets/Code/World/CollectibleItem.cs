...
public class CollectibleItem : MonoBehaviour {
	...
	void Update() {
		...
		// Layer-specific vocal approval — synthesised formant voice unique to each persona
		var voice = CollectibleAudio.GetVoice(this.requiredWLayer);
		AudioSource.PlayClipAtPoint(voice, this.transform.position, 0.80f);
