Shader "Custom/BuildingTriplanar_Transparent" {
    Properties {
    ...
    SubShader {
        ...
        // Alpha outside instancing buffer so MaterialPropertyBlock.SetFloat always applies
        float _Alpha;
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
            ...
            col.rgb = lerp(col.rgb,
                           lerp(col.rgb * 0.46, saturate(col.rgb + bv), faceMask),
                           brickStr * sideW);
